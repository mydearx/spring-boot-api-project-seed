package com.smart.project.core;

/**
 * 项目常量
 */
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.smart.project";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
    public static final String MAPPER_PLUGIN_TYPE = "tk.mybatis.mapper.generator.MapperPlugin";
    ...
    //替换修改表的前缀，控制mapping path
    public static final String TABLE_PREFIX = "^t\\_";
    public static final String TABLE_REPLACE = "";
}
